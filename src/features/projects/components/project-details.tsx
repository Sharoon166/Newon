  ...
  return (
    <div className="grid grid-cols-12 gap-6">
      ...
      <div className="col-span-12 lg:col-span-4 space-y-6">
        ...
        {canViewProjectInvoice && (
          <div className="group relative flex flex-col gap-5 p-5 border rounded-xl bg-background hover:shadow-sm transition-all">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">
                  {formatDate(new Date(projectInvoice?.date ?? Date.now()))}
                </div>
              </div>

              <div className="text-right">
                <div className="text-lg font-semibold tracking-tight">
                  {formatCurrency(projectInvoice?.totalAmount)}
                </div>
