...
const columns: ColumnDef<Invoice>[] = [
  ...
  },
  {
    ...
    header: 'Status',
    cell: ({ row }) => (
      <Badge variant={statusVariant[row.original.status as InvoiceStatus]}>
        {statusText[row.original.status as InvoiceStatus]}
      </Badge>
    )
  },
  {
    ...
    <div className="space-y-4">
      <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Recent invoices from your business</p>
        </div>
