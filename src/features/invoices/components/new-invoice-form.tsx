...
export function NewInvoiceForm({ onPreview }: { onPreview: (data: InvoiceFormValues) => void }) {
								...
								<FormItem>
									...
									<FormControl>
										<InputGroup>
											...
											<InputGroupInput placeholder="Client Company" {...field} />
										</InputGroup>
									</FormControl>
									<FormMessage />
								</FormItem>
								...
								<FormItem>
									...
									<FormControl>
										<InputGroup>
											...
											<InputGroupInput type="tel" placeholder="+1 (555) 123-4567" {...field} />
										</InputGroup>
									</FormControl>
									<FormMessage />
								</FormItem>
								...
								<FormItem>
									...
									<FormControl>
										<InputGroup>
											...
											<InputGroupInput placeholder="New York" {...field} />
										</InputGroup>
									</FormControl>
									<FormMessage />
								</FormItem>
