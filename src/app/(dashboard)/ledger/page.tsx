...
export default async function LedgerPage() {
  const [ledgersData, summary] = await Promise.all([getCustomerLedgers(), getLedgerSummary()]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Track customer transactions, payments, and outstanding balances"
      />
