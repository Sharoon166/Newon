    ...
    <div className={cn(`my-1 mt-4 flex flex-col sm:flex-row items-center justify-between gap-3 w-full`, className)}>
      <div className="flex items-center space-x-2">
        <p className="text-sm text-muted-foreground">
          ...
          <span className="font-medium">{Math.min((pageIndex + 1) * pageSize, totalRows)}</span> of{' '}
          <span className="font-medium">{totalRows}</span> {itemName}
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-2">
        ...
        <div className="flex items-center space-x-1">
          <Button variant="outline" className="h-8 w-8 p-0" onClick={handleFirstPage} disabled={!canPreviousPage}>
          ...
          <Button variant="outline" className="h-8 w-8 p-0" onClick={handleLastPage} disabled={!canNextPage}>
